...
--
-- Host: localhost
-- Generation Time: Sep 16, 2015 at 09:59 AM
...
CREATE TABLE `Album` (
  `AlbumId` int(11) NOT NULL COMMENT 'Unique album idenfier. Each album should only be captured once.',
  `Title` varchar(160) NOT NULL COMMENT 'Album title. Must be less than 160 characters.',
  `ArtistId` int(11) NOT NULL COMMENT 'Artist identifier, used to link to Artist table.'
) ENGINE=InnoDB AUTO_INCREMENT=348 DEFAULT CHARSET=utf8 COMMENT='Track albums including artist indentifier.';
...
CREATE TABLE `Artist` (
  `ArtistId` int(11) NOT NULL COMMENT 'Unique system generated artist identifier.',
  `Name` varchar(120) DEFAULT NULL COMMENT 'Name of the artist.'
) ENGINE=InnoDB AUTO_INCREMENT=276 DEFAULT CHARSET=utf8 COMMENT='All artists. Not all artists are musicians.';
...
CREATE TABLE `Customer` (
  `CustomerId` int(11) NOT NULL COMMENT 'Unique system generated customer identifier.',
  `FirstName` varchar(40) NOT NULL COMMENT 'Customer first name, requred.',
  `LastName` varchar(20) NOT NULL COMMENT 'Customer surname/lastname, required.',
  `Company` varchar(80) DEFAULT NULL COMMENT 'Customer''s company name. Not required.',
  `Address` varchar(70) DEFAULT NULL COMMENT 'Customer address, not required.',
  `City` varchar(40) DEFAULT NULL COMMENT 'Customer''s city of residence. Not required.',
  `State` varchar(40) DEFAULT NULL COMMENT 'Customer state or province. Not required.',
  `Country` varchar(40) DEFAULT NULL COMMENT 'Customer''s country of residence.',
  `PostalCode` varchar(10) DEFAULT NULL COMMENT 'Customer postal code.',
  `Phone` varchar(24) DEFAULT NULL,
  `Fax` varchar(24) DEFAULT NULL COMMENT 'Customer''s fax number ',
  `Email` varchar(60) NOT NULL COMMENT 'Customer''s email address. Required.',
  `SupportRepId` int(11) DEFAULT NULL COMMENT 'Employee ID for customer support.'
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='All customers, contact details and support employee.';
...
CREATE TABLE `Employee` (
  `EmployeeId` int(11) NOT NULL COMMENT 'Unique system generated employee identifier.',
  `LastName` varchar(20) NOT NULL COMMENT 'Employee surname or last name.',
  `FirstName` varchar(20) NOT NULL COMMENT 'Employee''s first name. Required.',
  `Title` varchar(30) DEFAULT NULL COMMENT 'Employee title e.g. Ms, Miss, Mrs, Dr. Not required',
  `ReportsTo` int(11) DEFAULT NULL COMMENT 'Employee''s manager employee ID. Not required.',
  `BirthDate` datetime DEFAULT NULL COMMENT 'Employee date of birth.',
  `HireDate` datetime DEFAULT NULL COMMENT 'Employment start date at Chinook',
  `Address` varchar(70) DEFAULT NULL COMMENT 'Employee''s full address. Street and number.',
  `City` varchar(40) DEFAULT NULL COMMENT 'Address city, needs to be separate from address field.',
  `State` varchar(40) DEFAULT NULL COMMENT 'Employee state or province.',
  `Country` varchar(40) DEFAULT NULL COMMENT 'Employee country.',
  `PostalCode` varchar(10) DEFAULT NULL COMMENT 'Employee postal code.',
  `Phone` varchar(24) DEFAULT NULL,
  `Fax` varchar(24) DEFAULT NULL COMMENT 'Employee fax number.',
  `Email` varchar(60) DEFAULT NULL COMMENT 'Employee fax number'
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='All Chinook employees including supervisors. ';
...
CREATE TABLE `Genre` (
  `GenreId` int(11) NOT NULL COMMENT 'Unique system generated genre identifier.',
  `Name` varchar(120) DEFAULT NULL COMMENT 'Genre name'
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='Track genres';
...
CREATE TABLE `Invoice` (
  `InvoiceId` int(11) NOT NULL COMMENT 'Unique system generated invoice identifier.',
  `CustomerId` int(11) NOT NULL COMMENT 'Customer ID, links to customer table.',
  `InvoiceDate` datetime NOT NULL COMMENT 'Date of purchase',
  `BillingAddress` varchar(70) DEFAULT NULL COMMENT 'Billing address, may be different from customer address.',
  `BillingCity` varchar(40) DEFAULT NULL COMMENT 'Billing city which may be different from customer city.',
  `BillingState` varchar(40) DEFAULT NULL COMMENT 'Billing state or province.',
  `BillingCountry` varchar(40) DEFAULT NULL COMMENT 'Billing country which may be different from customer country.',
  `BillingPostalCode` varchar(10) DEFAULT NULL COMMENT 'Billing postal code.',
  `Total` decimal(10,2) NOT NULL COMMENT 'Invoice total amount.'
) ENGINE=InnoDB AUTO_INCREMENT=413 DEFAULT CHARSET=utf8 COMMENT='Header level invoice data. Includes billing address, date and total amount.';
...
CREATE TABLE `InvoiceLine` (
  `InvoiceLineId` int(11) NOT NULL COMMENT 'Unique system generated invoice line identifier.',
  `InvoiceId` int(11) NOT NULL COMMENT 'Invoice header id. Joins to Invoice table. ',
  `TrackId` int(11) NOT NULL COMMENT 'Unique track identifier. Joins to track table.',
  `UnitPrice` decimal(10,2) NOT NULL COMMENT 'Unit price for each track. ',
  `Quantity` int(11) NOT NULL COMMENT 'Number of tracks bought.'
) ENGINE=InnoDB AUTO_INCREMENT=2241 DEFAULT CHARSET=utf8 COMMENT='Invoice details. Have track and quantity that were purchased.';
...
CREATE TABLE `MediaType` (
  `MediaTypeId` int(11) NOT NULL COMMENT 'Unique system generated media type identifier.',
  `Name` varchar(120) CHARACTER SET utf8 DEFAULT NULL COMMENT 'Media type name.'
...
CREATE TABLE `Playlist` (
  `PlaylistId` int(11) NOT NULL COMMENT 'Unique system generated play list identifier.',
  `Name` varchar(120) DEFAULT NULL COMMENT 'Playlist name'
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='List of playlists available.';
...
CREATE TABLE `PlaylistTrack` (
  `PlaylistId` int(11) NOT NULL COMMENT 'Playlist identifier, join to Playlist table to get playlist names.',
  `TrackId` int(11) NOT NULL COMMENT 'Track identifier, join to Track table to get track name.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Lists play lists by tracks. ';
...
CREATE TABLE `Track` (
  `TrackId` int(11) NOT NULL COMMENT 'Unique system generated track identifier.',
  `Name` varchar(200) NOT NULL COMMENT 'Track name',
  `AlbumId` int(11) DEFAULT NULL COMMENT 'Album identifier, join to Album to get album details.',
  `MediaTypeId` int(11) NOT NULL COMMENT 'Media type identifier. Join to MediaType table for media type details.',
  `GenreId` int(11) DEFAULT NULL COMMENT 'Genre identifier, join to Genre table to get genre name.',
  `Composer` varchar(220) DEFAULT NULL COMMENT 'Person or group who composed the track. This may be different from the artist who performs track.',
  `Milliseconds` int(11) NOT NULL COMMENT 'Track length in milliseconds. 1000 milliseconds equals 1 second.',
  `Bytes` int(11) DEFAULT NULL COMMENT 'Size in bytes of track. Used to monitor bandwidth usage.',
  `UnitPrice` decimal(10,2) NOT NULL COMMENT 'Track price'
) ENGINE=InnoDB AUTO_INCREMENT=3504 DEFAULT CHARSET=utf8 COMMENT='Track information';
...
--
ALTER TABLE `Album`
  MODIFY `AlbumId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique album idenfier. Each album should only be captured once.',AUTO_INCREMENT=348;
--
-- AUTO_INCREMENT for table `Artist`
--
ALTER TABLE `Artist`
  MODIFY `ArtistId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated artist identifier.',AUTO_INCREMENT=276;
--
-- AUTO_INCREMENT for table `Customer`
--
ALTER TABLE `Customer`
  MODIFY `CustomerId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated customer identifier.',AUTO_INCREMENT=60;
--
-- AUTO_INCREMENT for table `Employee`
--
ALTER TABLE `Employee`
  MODIFY `EmployeeId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated employee identifier.',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `Genre`
--
ALTER TABLE `Genre`
  MODIFY `GenreId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated genre identifier.',AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT for table `Invoice`
--
ALTER TABLE `Invoice`
  MODIFY `InvoiceId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated invoice identifier.',AUTO_INCREMENT=413;
--
-- AUTO_INCREMENT for table `InvoiceLine`
--
ALTER TABLE `InvoiceLine`
  MODIFY `InvoiceLineId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated invoice line identifier.',AUTO_INCREMENT=2241;
--
-- AUTO_INCREMENT for table `MediaType`
--
ALTER TABLE `MediaType`
  MODIFY `MediaTypeId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated media type identifier.',AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `Playlist`
--
ALTER TABLE `Playlist`
  MODIFY `PlaylistId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated play list identifier.',AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `Track`
--
ALTER TABLE `Track`
  MODIFY `TrackId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique system generated track identifier.',AUTO_INCREMENT=3504;
--
